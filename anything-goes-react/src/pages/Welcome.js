...
const Welcome = () => {
  return (
    <div id="Welcome" style={{ height: "100vh" }}>
      ...
      <br></br>
      <p>
        YOU ARE ABOUT TO ENTER ONE OF THE FIERCEST FIGHTING COMPETITIONS EVER
        ORCHESTRATED! ARE YOU READY TO WIN OR WILL YOUR FIGHTERS BE CRUSHED
        UNDERNEATH THE OVERWHELMING PRESSURE??
      </p>
      <br></br>
      <p>Its time to enter the ring.</p>
      <br></br>
